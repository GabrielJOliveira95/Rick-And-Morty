    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra(Intent.EXTRA_EMAIL, new String[]{"gabrieljoliveira95@gmail.com"});
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home,R.id.nav_send, R.id.nav_episodies, R.id.nav_localization, R.id.nav_characters, R.id.nav_opening)
